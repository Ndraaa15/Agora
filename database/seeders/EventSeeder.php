    ...
    public function run(): void
    {
        ...
        $events = [
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/pendet-2.jpeg']),
            ...
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_21.png']),
            ...
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_31.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_14.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_31-3.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'city' => 'Yogyakarta',
                'description' => 'Menampilkan musisi keroncong ternama',
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_31-1.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'city' => 'Surakarta',
                'description' => 'Menampilkan musisi keroncong ternama',
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_22.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'city' => 'Surakarta',
                'description' => 'Menampilkan musisi keroncong ternama',
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_29.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
            ...
            [
                ...
                'images' => (['https://arcudskzafkijqukfool.supabase.co/storage/v1/object/public/Agora/Rectangle_27.png']),
                'start_date' => Carbon::createFromFormat('d-m-Y', '15-12-2024'),
                'end_date' => Carbon::createFromFormat('d-m-Y', '20-12-2024'),
                'date' => Carbon::createFromFormat('d-m-Y', '21-12-2024'),
                'time' => Carbon::createFromTime(8, 30, 00)->format('H:i'),
