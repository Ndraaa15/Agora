    ...
    <div class="mb-20">
        <div class="flex flex-row gap-0">
            <div class="flex flex-row relative items-center w-full">
                ...
                <input id="search-input" placeholder="What are you looking for..." type="text" name="search" id="search" class="pl-10 outline-none border border-blue-400 w-full py-2 pr-8 rounded-md rounded-br-none rounded-tr-none" onkeypress="handleKeyPress(event)">
            </div>
            <button class="py-2 px-6 bg-blue-400 rounded-md rounded-bl-none rounded-tl-none text-white font-medium" onclick="searchEvent()">Search</button>
            <script>
