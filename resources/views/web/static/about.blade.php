...
@section('content')
    ...
    <div class="flex w-full 2xl:mt-[120px] sm:mt-[70px] sm:flex-col sm:justify-center sm:items-center">
        <div class="row relative">
            <div class="2xl:w-[720px] xl:w-[600px] lg:w-[500px] md:w-[400px] sm:w-[300px] absolute 2xl:left-[100px] xl:left-[100px] sm:left-[20px]">
                <h1 class="text-[#0C356A] font-semibold 2xl:text-[36px] xl:text-[30px] lg:text-[28px] md:text-[24px] sm:text-[18px] text-left pt-[10px] pb-[10px]">About Agora</h1>
                ...
                <div class="flex flex-row mt-[20px] sm:text-[14px]">
                    <button class="w-[75px] h-[30px] sm:w-[50px] border-2 border-solid border[#6D758F] text-[#0d6efd] rounded-[20px] flex justify-center items-center mr-[10px] hover:bg-[#0d6efd] hover:text-white">Culture</button>
                    <button class="w-[75px] h-[30px] sm:w-[50px] border-2 border-solid border[#6D758F] text-[#0d6efd] rounded-[20px] flex justify-center items-center mr-[10px] hover:bg-[#0d6efd] hover:text-white">Music</button>
                    <button class="w-[75px] h-[30px] sm:w-[50px] border-2 border-solid border[#6D758F] text-[#0d6efd] rounded-[20px] flex justify-center items-center mr-[10px] hover:bg-[#0d6efd] hover:text-white">Dance</button>
                    <button class="w-[75px] h-[30px] sm:w-[50px] border-2 border-solid border[#6D758F] text-[#0d6efd] rounded-[20px] flex justify-center items-center mr-[10px] hover:bg-[#0d6efd] hover:text-white">Art</button>
                </div>
            </div>
            <div class="absolute right-0">
                <img src="{{ asset('assets/images/Intersect1.svg') }}" alt="Image 1" class="absolute 2xl:w-[230px] sm:w-[120px] md:w-[150px] lg:w-[170px] xl:w-[200px] 2xl:right-[450px] sm:right-[160px] md:right-[200px] lg:right-[290px] xl:right-[430px] xl:top-[70px] sm:top-[20px] z-1">
                <img src="{{ asset('assets/images/intersect2.svg') }}" alt="Image 2" class="absolute 2xl:w-[230px] sm:w-[120px] md:w-[150px] lg:w-[170px] xl:w-[200px] 2xl:right-[190px] sm:right-[20px] md:right-[30px] lg:right-[100px] xl:right-[200px] xl:top-[100px] sm:top-[40px] z-1">
                <img src="{{ asset('assets/images/intersect3.svg') }}" alt="Image 3" class="absolute 2xl:w-[230px] sm:w-[120px] md:w-[150px] lg:w-[170px] xl:w-[200px] 2xl:right-[310px] sm:right-[80px] md:right-[110px] lg:right-[190px] xl:right-[320px] 2xl:top-[200px] sm:top-[120px] md:top-[150px] lg:top-[170px] xl:top-[210px] z-2">
            </div>
        </div>
    </div>

    <h1 class="text-[#0C356A] font-semibold text-center w-full pb-4 2xl:text-4xl xl:text-[30px] lg:text-[28px] md:text-[24px] sm:text-[18px] 2xl:mt-[500px] sm:mt-[270px] md:mt-[350px] lg:mt-[380px] xl:mt-[450px]">Our Vision</h1>
    ...
    <h1 class="text-[#0C356A] font-semibold text-center w-full 2xl:text-4xl xl:text-[30px] lg:text-[28px] md:text-[24px] sm:text-[18px] 2xl:mt-[100px] sm:mt-[50px] 2xl:mb-[80px]">Partnership</h1>
