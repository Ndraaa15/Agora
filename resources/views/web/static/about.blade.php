...
@section('content')
    ...
    <div class="flex w-full 2xl:mt-[120px] sm:mt-[70px] sm:flex-col sm:justify-center sm:items-center">
            ...
            <div class="2xl:w-[720px] xl:w-[600px] lg:w-[500px] md:w-[400px] sm:w-[300px] absolute 2xl:left-[150px] 2xl:top-[350px] xl:left-[100px] sm:left-[20px] sm:top-[180px] md:left-[40px] md:top-[200px] lg:left-[120px] lg:top-[220px] xl:left-[200px] xl:top-[300px]">
                ...
                <img src="{{ asset('assets/images/Intersect1.svg') }}"  alt="Image 1" class="absolute 2xl:w-[230px] sm:w-[120px] md:w-[150px] lg:w-[170px] xl:w-[200px] 2xl:right-[450px] 2xl:top-[350px] sm:right-[160px] md:right-[200px] lg:right-[290px] xl:right-[430px] xl:top-[330px] sm:top-[200px] md:top-[260px] sm:top-[200px] z-1">
                ...
                <img src="{{ asset('assets/images/intersect3.svg') }}" alt="Image 3" class="absolute 2xl:w-[230px] sm:w-[120px] md:w-[150px] lg:w-[170px] xl:w-[200px] 2xl:right-[310px] 2xl:top-[550px] sm:right-[80px] md:right-[110px] lg:right-[190px] xl:right-[320px] 2xl:top-[200px] xl:top-[470px] sm:top-[300px] md:top-[380px] lg:top-[400px] xl:top-[210px] z-2">
