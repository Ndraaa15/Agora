        ...
        <div class="flex flex-row justify-evenly">
            <div class="p-10 w-1/2 shadow-lg bg-white rounded-lg">
                ...
                <div class="flex flex-col gap-2 mb-3">
                    ...
                    <input type="text" name="name" id="name" class="w-full border border-gray-400 rounded-lg py-1 px-5 shadow-lg">
                </div>
                <div class="flex flex-col gap-2 mb-3">
                    <label for="email" class="font-light text-gray-500">Email</label>
                    <input type="text" name="email" id="email" class="w-full border border-gray-400 rounded-lg py-1 px-5 shadow-lg">
                </div>
                <div class="flex flex-col gap-2 mb-3">
                    <label for="phone" class="font-light text-gray-500">Phone</label>
                    <input type="text" name="phone" id="phone" class="w-full border border-gray-400 rounded-lg py-1 px-5 shadow-lg">
                </div>
            </div>
            <div class="w-1/4 p-5 shadow-lg rounded-lg">
                ...
                <div class="flex flex-row justify-between items-center mt-5" data-ticket-price="{{ $ticketSection->price }}">
                    <div class="flex flex-row items-center gap-3">
                        ...
                        <input type="number" id="quantity-input" value="1" min="1" class="w-8 text-center rounded border-none">
